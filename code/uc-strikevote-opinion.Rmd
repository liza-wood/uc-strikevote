...
knitr::opts_chunk$set(
  echo = FALSE, warning = F, out.width = "75%", error = F, message = F)
```
...
**The UC's current proposal** -- which has been rejected by the Union -- is for a 7% raise increase. This kind of raise would bring the minimum from \$28,622 to \$30,625.54. This might sound exciting, but let's note that 3% of that is a standard inflation increase and the remaining 4% still does not cover the rate of inflation that we've endured in 2022. And in the context of living wages, this still leaves Davis far below average compared to its peers, with minimum workers earning only .75 of the living wage.  
...
Instead, **UAW's proposal** is to set an ambitious new minimum of $54,000 at 50% FTE. 
```{r}
