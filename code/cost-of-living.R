...
census <- read.csv("data/uscb.csv") %>% 
  ...
  rename(#"per_capita_income" = Fact,
         "University of Michigan" = Ann.Arbor.city..Michigan,
         "Arizona State University" = Tempe.city..Arizona,
         "University of Indiana" = Bloomington.city..Indiana,
  ...
  pivot_longer(cols = `University of Michigan`:`University of Georgia`, 
